...
const getInventoryItemById = catchAsync(async (req, res) => {
  const result = await InventoryService.getInventoryItemById(String(req.params.id));
  sendResponse(res, {
    statusCode: StatusCode.OK,
    success: true,
...
const updateInventoryItem = catchAsync(async (req, res) => {
  const result = await InventoryService.updateInventoryItem(String(req.params.id), req.body);
  sendResponse(res, {
    statusCode: StatusCode.OK,
    success: true,
